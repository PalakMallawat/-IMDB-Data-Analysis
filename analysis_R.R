...
analysis<-function(){
  #updateR()
  source("/Users/welcome/Downloads/BI_active_learning/multiplot_R.r") 
  
  #Read in Cleaned File for analysis
  data2<-read.csv("/Users/welcome/Downloads/BI_active_learning/Data_Files/R-Cleaned-File.csv",stringsAsFactors = FALSE)
  
  data2<-as.data.frame(data2)
  
  
  #Get movies with more than 7500 votes and 6 user rating
  movies_with_more_than_7500_votes_and_6_user_rating<-subset(data2,data2$Votes>7500 & data2$User.Rating>6 & data2$Release.Year<2022)
